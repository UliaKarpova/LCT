    ...
    <main className="main">
      ...
      >
        <select disabled className="grade_select">
          <option className="grade placeholder" defaultValue="">
            Грейд
          </option>
          <option className="grade" value="1">
            Синьор
          </option>
          <option className="grade" value="2">
            Мидл
          </option>
          <option className="grade" value="3">
            Джун
          </option>
        </select>
      </ManagerPanel>
